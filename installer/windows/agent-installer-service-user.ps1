...
try {
    Invoke-WebRequest -Uri "${OPENAEV_URL}/api/tenants/${OPENAEV_TENANT_ID}/agent/package/openaev/windows/${architecture}/service-user" -Headers @{ "Authorization" = "Bearer ${OPENAEV_TOKEN}" } -OutFile "agent-installer-service-user.exe";
