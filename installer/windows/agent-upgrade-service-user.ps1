...
Invoke-WebRequest -Uri "${OPENAEV_URL}/api/tenants/${OPENAEV_TENANT_ID}/agent/executable/openaev/windows/${architecture}" -Headers @{ "Authorization" = "Bearer ${OPENAEV_TOKEN}" } -OutFile $AgentUpgradedPath;
