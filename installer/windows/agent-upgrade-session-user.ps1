...
Invoke-WebRequest -Uri "${OPENAEV_URL}/api/tenants/${OPENAEV_TENANT_ID}/agent/package/openaev/windows/${architecture}/session-user" -Headers @{ "Authorization" = "Bearer ${OPENAEV_TOKEN}" } -OutFile "openaev-installer-session-user.exe";
